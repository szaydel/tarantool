...
admin("box.remove_on_request(id)")
admin("id = box.on_request(function(req, skip) return req.space end)")
admin("box.select(23, 12, 1)")
admin("box.delete(24, 12, 1)")
admin("box.update(25, 12, '=p', 1, 2)")
admin("box.insert(26, 2, 2, 3)")
...
admin("box.remove_on_request(id)")
admin("id = box.on_request(function(req, skip) return req.index end)")
admin("box.select(23, 12, 1)")
...
admin("box.remove_on_request(id)")
admin("id = box.on_request(function(req, skip) return req.format end)")
admin("box.update(23, 12, '=p!p#p', 11, 2, 12, 3, 34, 4)")

admin("box.remove_on_request(id)")
admin("id = box.on_request(function(req, skip) return req.opargs end)")
